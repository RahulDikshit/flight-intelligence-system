...
def prepare_features(df: pd.DataFrame):
    # Drop timestamp from modeling for now
...
def main():
    ...
    joblib.dump(logistic_model, MODEL_DIR / "logistic_anomaly_model.pkl")
    joblib.dump(rf_model, MODEL_DIR / "rf_anomaly_model.pkl")

    print("\nSaved models to:")
    print(MODEL_DIR / "logistic_anomaly_model.pkl")
    print(MODEL_DIR / "rf_anomaly_model.pkl")
